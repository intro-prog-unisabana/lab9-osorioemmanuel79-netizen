...
def main():
    ...
    while True:
        ...
        if option == "1":
            ...
            print("Car added.")           # 🔥 requerido por test
            print(car)                   # 🔥 requerido por test
            ...
            if car_id in car_dict:
                ...
                print("Mileage updated.")  # 🔥 requerido
                print(car_dict[car_id])    # 🔥 requerido
            else:
                print("Car not found.")
